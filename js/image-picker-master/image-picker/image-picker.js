...
(function() {
  ...
  ImagePickerOption = (function() {
    ...
    ImagePickerOption.prototype.mark_as_selected = function() {
      return this.node.find(".panel-body").addClass("sel");
    };

    ImagePickerOption.prototype.unmark_as_selected = function() {
      return this.node.find(".panel-body").removeClass("sel");
    };
    ...
    ImagePickerOption.prototype.caption = function() {
      if (this.option.data("img-caption")) {
        return this.option.data("img-caption");
      } else {
        return this.option.text();
      }
    };
    ...
    ImagePickerOption.prototype.create_node = function() {
      var image, thumbnail, panelBody, outerWrapper, panelHeader, panelFooter;
      this.node = jQuery("<li/>");
      //image = jQuery("<img class='image_picker_image' width='234' height='307'/>");
      image = jQuery("<img class='select-tapiserija-body'/>");
      image.attr("src", this.option.data("img-src"));
      panelBody = jQuery("<div class='panel-body'>");
      panelHeader = jQuery(" <div class='panel-heading text-center select-tapiserija-heading'>");
      panelFooter = jQuery("<div class='panel-footer'>");
      outerWrapper = jQuery("<div class='col-sm-4 col-md-4 col-lg-4'>");

      //thumbnail = jQuery("<div class='thumbnail'>");
      thumbnail = jQuery("<div class='thumbnail panel panel-default'>");
      thumbnail.click({
        option: this
      }, function(event) {
      ...
      thumbnail.append(panelHeader.append(this.caption()));
      thumbnail.append(panelBody);

      outerWrapper.append(thumbnail);
      if (this.opts.show_label) {
        //thumbnail.append(jQuery("<p/>").html(this.label()));
        thumbnail.append(panelFooter.append(this.label()));

      }
      this.node.append(outerWrapper);
      return this.node;
    };
